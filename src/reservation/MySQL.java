...
public class MySQL {
	...
	public MySQL() {
		...
		this.dbname  = "50416016";         // データベース名;
		this.url = "jdbc:mysql://" + server + "/" + dbname + "?useUnicode=true&characterEncoding=UTF-8";
		this.user = "50416016";         // データベース作成ユーザ名
		this.password  = "50416016";     // データベース作成ユーザパスワード;
	...
	public ResultSet getExplanation(String facility){
	...
	public ResultSet getYoyaku(String Yoyaku){
		String sql = "SELECT * FROM reservation WHERE facility_name ='" + Yoyaku + "';";
		try {
			rs = stmt.executeQuery(sql);
		} catch (SQLException e) {
			// TODO Auto-generated catch block
	...
	public int setCancel(String rdate, String st, String et, String facility){
		int rs_int = 0;
		String sql = "DELETE FROM reservation WHERE facility_name = '"+ facility
				      + "' AND date = '" + rdate
				      + "' AND start_time = '" + st 
				      + "' AND end_time = '" + et +"';";
		try {
